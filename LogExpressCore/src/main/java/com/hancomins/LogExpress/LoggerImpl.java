...
class LoggerImpl implements Logger {
    ...
    public void fatal(CharSequence messages) {
        baseLogger.fatal("",messages, addedStackTraceElementIndex);
    }

    @Override
    public void fatal(String messages, Object... args) {
        baseLogger.fatal("",MessageFormatter.newFormat(messages,args), addedStackTraceElementIndex);
    }

    @Override
    public void fatal(CharSequence messageFormatter, Throwable e) {
        baseLogger.fatal("", messageFormatter, e, addedStackTraceElementIndex);
    }
