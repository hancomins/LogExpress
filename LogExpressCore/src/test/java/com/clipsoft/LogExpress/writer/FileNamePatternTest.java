...
public class FileNamePatternTest extends TestCase {
    ...
    public void testFileNamePattern() throws IOException {
        ...
        FileNamePattern fileNamePattern = FileNamePattern.parse("/Program Files (x86)/Clipsoft/CLIP eForm v5.0/CLIPreportAPIServer-previewer/log/{hostname}/{pid}.{hostname}.api.{date:yyyy-MM-dd}_{number}.log");
